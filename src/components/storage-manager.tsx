...
export function StorageManager() {
  ...
  const handleInspect = () => {
    try {
      // Instead of just logging to console, capture the inspection data
  ...
  // Calculate storage health metrics
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <ActionButton
                ...
                description="Refresh storage capacity and health information displayed above"
                onClick={checkHealth}
